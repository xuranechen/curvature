...
func TestRestoredEnvironmentFiltersSessionAndInternalValues(t *testing.T) {
	for _, key := range []string{"PWD", "SSH_AUTH_SOCK", "TERM_SESSION_ID", "CURVATURE_DAEMON", "curvature_internal_restart"} {
