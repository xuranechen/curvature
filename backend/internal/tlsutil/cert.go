...
// os.UserConfigDir/curvature/ and reused across restarts.
func EnsureCert(certFile, keyFile string) (string, string, error) {
	...
	certPath := filepath.Join(configDir, "curvature", "cert.pem")
	keyPath := filepath.Join(configDir, "curvature", "key.pem")
