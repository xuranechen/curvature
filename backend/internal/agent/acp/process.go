...
import (
	...
	types "curvature/backend/internal/agent/types"
...
// curvatureClient implements acp.Client interface
type curvatureClient struct {
	proc *Process
}
...
func (c *curvatureClient) SessionUpdate(ctx context.Context, params acp.SessionNotification) error {
...
func (c *curvatureClient) RequestPermission(ctx context.Context, params acp.RequestPermissionRequest) (acp.RequestPermissionResponse, error) {
...
func (c *curvatureClient) ReadTextFile(ctx context.Context, params acp.ReadTextFileRequest) (acp.ReadTextFileResponse, error) {
	// Agent handles file operations itself
	return acp.ReadTextFileResponse{Content: ""}, nil
}

func (c *curvatureClient) WriteTextFile(ctx context.Context, params acp.WriteTextFileRequest) (acp.WriteTextFileResponse, error) {
	return acp.WriteTextFileResponse{}, nil
}

func (c *curvatureClient) CreateTerminal(ctx context.Context, params acp.CreateTerminalRequest) (acp.CreateTerminalResponse, error) {
	return acp.CreateTerminalResponse{}, nil
}

func (c *curvatureClient) TerminalOutput(ctx context.Context, params acp.TerminalOutputRequest) (acp.TerminalOutputResponse, error) {
	return acp.TerminalOutputResponse{}, nil
}

func (c *curvatureClient) ReleaseTerminal(ctx context.Context, params acp.ReleaseTerminalRequest) (acp.ReleaseTerminalResponse, error) {
	return acp.ReleaseTerminalResponse{}, nil
}

func (c *curvatureClient) WaitForTerminalExit(ctx context.Context, params acp.WaitForTerminalExitRequest) (acp.WaitForTerminalExitResponse, error) {
	return acp.WaitForTerminalExitResponse{}, nil
}

func (c *curvatureClient) KillTerminal(ctx context.Context, params acp.KillTerminalRequest) (acp.KillTerminalResponse, error) {
	return acp.KillTerminalResponse{}, nil
}

func (c *curvatureClient) HandleExtensionMethod(_ context.Context, method string, params json.RawMessage) (any, error) {
	switch method {
...
func (c *curvatureClient) handleQwenSlashCommandNotification(params json.RawMessage) error {
...
func Start(ctx context.Context, agentName, command string, args []string, cwd string, env map[string]string) (*Process, error) {
	...
	proc.client = &curvatureClient{proc: proc}
...
// NewSession creates a new ACP session for the given Curvature session key.
...
// ForgetSession removes only Curvature' local bookkeeping for a session.
...
// SessionID returns the ACP session ID for a Curvature session key.
