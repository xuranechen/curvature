...
const SURFACE = "var(--curvature-launcher-surface)";
const SURFACE_STRONG = "var(--curvature-launcher-surface-strong)";
const BORDER = "var(--curvature-launcher-border)";
const BORDER_STRONG = "var(--curvature-launcher-border-strong)";
const TEXT = "var(--curvature-launcher-text)";
const MUTED = "var(--curvature-launcher-muted)";
const ACCENT = "var(--curvature-launcher-accent)";
const SHADOW = "var(--curvature-launcher-shadow)";
...
export function Login({ onOpenNode }: LoginProps): ReactElement {
  ...
  useEffect(() => {
    ...
    window.addEventListener("curvature:launcher-nodes-updated", handleLauncherNodesUpdated);

    return () => {
      cancelled = true;
      window.removeEventListener("curvature:launcher-nodes-updated", handleLauncherNodesUpdated);
  ...
  return (
    <div
      style={{
        minHeight: "100dvh",
        background: "var(--curvature-system-bar-bg)",
        color: TEXT,
        padding:
          "calc(var(--curvature-safe-area-top, env(safe-area-inset-top, 0px)) + 20px) 16px calc(var(--curvature-safe-area-bottom, env(safe-area-inset-bottom, 0px)) + 24px)",
        display: "flex",
    ...
    >
      <div
        style={{
          position: "fixed",
          inset: 0,
          background: `var(--curvature-launcher-bg, ${LAUNCHER_BG})`,
          pointerEvents: "none",
          zIndex: 0,
        }}
      />
      <div
        style={{
          ...
          maxWidth: "640px",
          minHeight:
            "calc(100dvh - var(--curvature-safe-area-top, env(safe-area-inset-top, 0px)) - var(--curvature-safe-area-bottom, env(safe-area-inset-bottom, 0px)) - 44px)",
          display: "flex",
      ...
      >
                  ...
                  {editingNodeID === node.id ? (
                    <input
                      ...
                      style={{
                        ...
                        background: "var(--curvature-launcher-input-bg)",
                        padding: "6px 10px",
                        fontSize: "17px",
                        fontWeight: 500,
                        color: TEXT,
        ...
        <button
          ...
          style={{
            ...
            borderRadius: "20px",
            background: "var(--curvature-launcher-surface-soft)",
            padding: "18px",
            fontSize: "24px",
            fontWeight: 500,
            color: MUTED,
        ...
        >
          <form
            ...
            style={{
              ...
              borderRadius: "22px",
              background: SURFACE_STRONG,
              border: `1px solid var(--curvature-launcher-modal-border)`,
              boxShadow: SHADOW,
              padding: "18px",
              backdropFilter: "blur(20px)",
              display: "grid",
          ...
          >
            <input
              ...
              style={{
                width: "100%",
                borderRadius: "14px",
                border: `1px solid ${formError ? "var(--curvature-launcher-error-text)" : BORDER_STRONG}`,
                background: "var(--curvature-launcher-input-bg)",
                padding: "14px 15px",
                fontSize: "15px",
                color: TEXT,
