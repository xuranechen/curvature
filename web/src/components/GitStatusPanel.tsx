...
export function GitStatusPanel({
  ...
  return (
    <section style={{ padding: 0, flexShrink: 0, minWidth: 0 }}>
      {showHeader ? (
      <div
        className="curvature-git-status-header"
        style={{
          display: "grid",
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: compact ? "6px" : "8px", minWidth: 0, overflow: "visible" }}>
          ...
          {status?.branch ? (
            <div
              ref={branchMenuRef}
              className={compact ? "curvature-git-branch-wrap curvature-git-branch-wrap-compact" : "curvature-git-branch-wrap"}
              data-branch-tooltip={branchMenuOpen ? undefined : status.branch}
              style={{ position: "relative", minWidth: 0, flex: "1 1 auto", maxWidth: "100%" }}
            >
              <button
                type="button"
                className="curvature-git-branch-button"
              ...
              >
                <span className="curvature-git-branch-label" style={{ fontSize: "12px", fontWeight: 600 }}>
                  {status.branch}
                </span>
