...
const PWA_INSTALL_STATE_KEY = "curvature-pwa-installed";
const RELAYER_AD_DISMISS_STORAGE_KEY = "curvature-relayer-ad-dismissed";
...
const PROJECT_TREE_TAB_STORAGE_KEY = "curvature-project-tree-tab";
  ...
  return (
    <span
      ...
      style={{
        ...
        borderRadius: "50%",
        animation: "curvature-update-spin 0.8s linear infinite",
...
export function FileTree({
  ...
  React.useEffect(() => {
    ...
    window.addEventListener("curvature:native-bridge-ready", refreshNativeRuntime);
    window.addEventListener("pageshow", refreshNativeRuntime);
    window.addEventListener("focus", refreshNativeRuntime);
    return () => {
      timers.forEach((timer) => window.clearTimeout(timer));
      window.removeEventListener("curvature:native-bridge-ready", refreshNativeRuntime);
              ...
              {showRootIndicator ? (
                <span
                  ...
                  style={{
                    ...
                    animation: isRootPending ? "curvature-bound-pulse 2.2s ease-in-out infinite" : "none",
  ...
  return (
    <div style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
      <div style={{ position: "relative", height: "36px", padding: "0 3px", borderBottom: "1px solid var(--border-color)", display: "flex", justifyContent: "space-between", alignItems: "center", background: "var(--curvature-topbar-bg, transparent)", boxSizing: "border-box", flexShrink: 0, gap: 0, overflow: "visible" }}>
        ...
        >
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              aria-hidden="true"
              style={treeRefreshing ? { animation: "curvature-update-spin 0.8s linear infinite" } : undefined}
            >
              <path
                fill="currentColor"
          ...
          {isMenuOpen ? (
            <div
              style={{
                ...
                top: "calc(100% + 6px)",
                right: 0,
                width: "var(--curvature-file-menu-width, 182px)",
      ...
      <div
        data-curvature-filetree-footer="1"
        style={{
      ...
      >
                ...
                {updateActionBusy ? (
                  <span
                    style={{
                      ...
                      display: "inline-block",
                      animation: "curvature-update-spin 0.9s linear infinite",
                    }}
                  />
                ) : null}
        ...
        {onOpenRelaySettings ? (
          ...
          >
            <span>{t("relay.openSettings")}</span>
          </button>
        ) : null}
        {relayActionHelp ? (
          <div style={{ fontSize: "11px", color: "var(--text-secondary)", lineHeight: 1.5, textAlign: "center" }}>
      ...
      <style>{`
        @keyframes curvature-update-spin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }
        @keyframes curvature-bound-pulse {
