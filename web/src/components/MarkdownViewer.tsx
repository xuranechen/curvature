...
function MermaidBlock({ chart }: { chart: string }) {
  ...
  useEffect(() => {
    ...
    const renderChart = async () => {
      ...
      const mermaid = await getMermaid();
      const renderId = `curvature-mermaid-${mermaidRenderId += 1}`;
    ...
    >
      ...
      <pre
        ...
        style={{
          width: "100%",
          boxSizing: "border-box",
          background: "var(--curvature-code-bg, #f8fafc)",
          color: "var(--curvature-code-text, var(--text-primary))",
          padding: "16px",
          borderRadius: "10px",
          overflow: "auto",
          border: "1px solid var(--curvature-code-border, var(--border-color))",
          fontFamily: monoFontFamily,
          fontSize: "13px",
          margin: 0,
          lineHeight: "1.6",
