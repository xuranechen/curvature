...
const HISTORY_LIST_STORAGE_PREFIX = "curvature.git.history.list:";
const COMMIT_FILES_STORAGE_PREFIX = "curvature.git.history.files:";
const COMMIT_DIFF_STORAGE_PREFIX = "curvature.git.history.diff.v2:";
