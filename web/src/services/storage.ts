...
const TOKEN_KEY = "curvature_token";
const API_BASE_URL_KEY = "curvature_api_base_url";
const WS_BASE_URL_KEY = "curvature_ws_base_url";
const LAUNCHER_NODES_KEY = "curvature_launcher_nodes";
