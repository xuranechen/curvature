...
function estimateCommandTerminalCols(): number | undefined {
  ...
  const inputWidth = maxElementWidth('[data-curvature-command-input-width="1"]');
  const contentWidth = maxElementWidth('[data-curvature-session-content-width="1"]');
...
const SESSION_CACHE_DB = "curvature-session-cache";
