...
const baseSnapshot = {
  rootPath: "/tmp/curvature-demo",
  plugins: [
    { path: ".curvature/plugins/a.js", sha256: "aaa", size: 12 },
    { path: ".curvature/plugins/b.js", sha256: "bbb", size: 34 },
  ],
};
  ...
  isPluginSnapshotTrusted(
    {
      ...baseSnapshot,
      plugins: [
        { path: ".curvature/plugins/a.js", sha256: "changed", size: 12 },
        { path: ".curvature/plugins/b.js", sha256: "bbb", size: 34 },
      ],
    },
    trusted,
  ...
  isPluginSnapshotTrusted(
    {
      ...
      plugins: [
        { path: ".curvature/plugins/a.js", sha256: "aaa", size: 12 },
        { path: ".curvature/plugins/b.js", sha256: "bbb", size: 34 },
        { path: ".curvature/plugins/c.js", sha256: "ccc", size: 56 },
      ],
    },
    trusted,
  ),
