...
func (b *BindService) poll(code, deviceID, purpose string) (map[string]any, error) {
	...
	case "confirmed":
		...
		if bind.Purpose == "token_station" && dev.TokenStationToken != "" {
			out["token_station_token"] = dev.TokenStationToken
		}
		return out, nil
